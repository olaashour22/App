    ...
    <div class="b-tabs" role="tablist">
        <a class="tab-item active" href="#app_description"><?php _e($opt_themes['exthemes_content_Description'], THEMES_NAMES); ?></a>
		<?php global $wpdb, $post, $wp_query; if (get_post_meta( $post->ID, 'wp_whatnews_GP', true )) { ?>
		<a class="tab-item" href="#whatnews"><?php _e($opt_themes['exthemes_content_Whats_News'], THEMES_NAMES); ?></a>
		<?php } ?>
		<noscript>
		<?php if ($youtube) { ?>
		<a class="tab-item" href="#youtubes"><?php _e('Youtube', THEMES_NAMES); ?></a>
		<?php } ?>
		<?php if ($modfeatures) { ?>
		...
		<a class="tab-item" href="#app_faq"><?php _e($opt_themes['exthemes_content_Help'], THEMES_NAMES); ?></a>
		<?php } ?>
    </div>
    <div class="b-cont tab-content">
		...
		<div class="showH">		
			<details class="ac alt">
				<summary><?php _e($opt_themes['exthemes_content_Mod_info'], THEMES_NAMES); ?> </summary>
				<div class="aC">
