...
<section class="wrp section">
		...
		<h3 class="section-title"><i class="s-yellow c-icon"><svg width="24" height="24"><use xlink:href="#i__apps"/></svg></i><?php _e($latest_post_title, THEMES_NAMES); ?></h3>
		</div>
		...
		<p style="text-align:center;padding:10px;"><?php _e('Ready to publish your first post?', THEMES_NAMES); ?> <a href="<?php echo esc_url( admin_url( 'post-new.php' ) ); ?>"><?php _e('Get started here', THEMES_NAMES); ?></a></p>
		</div>
		<?php endif; 
