            ...
            <div class="wrp-min block-list">
                <div class="block b-article">                    
                    ...
                    <div class="b-cont">                       
						...
						<div class="read-next" title="<?php _e('Read next', THEMES_NAMES); ?>"><?php next_post_link('%link', '%title' ); ?></div>
						<?php } ?>						
                        <div class="ya-share2" title="<?php _e('Share with friends', THEMES_NAMES); ?>" data-size="m" data-shape="round" data-services="telegram,vkontakte,facebook,odnoklassniki,twitter,viber,whatsapp"></div>
                    </div>
                </div>
