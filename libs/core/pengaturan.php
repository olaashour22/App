...
Redux::setSection( $opt_name, array(
    ...
    'fields'		   => array(
		...
		'style'			=> 'critical',
		'desc'			=> __('<a href="'.get_option("home").'/wp-admin/admin.php?page=wp_apk_mod_menu" target="_blank" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" data-original-height="416" data-original-width="1085" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgclZTK_UT8pafskJSThUm2Qix_dEF8bYp_zO5aKB70xVBgY2VLs9ou0pwjNdHYYbTAD8XsT8l48QakUgKynNMQHB9ToRKdwWxbtxzz3MMTD_isOr_L1fUkjr9CUrzea7WFEmf320TjU3iLpvKRne4fjx4KyqYAgJ4zbdZnN5l1SENuLSLAOMbwa0ofUQs/s1600/yutub.png"/></a>', THEMES_NAMES)
		),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'		   => array(			
			...
			'default'			=> 'Manrope, Arial, -apple-system, BlinkMacSystemFont, "Segoe UI", "Open Sans", "Helvetica Neue", sans-serif',		
			'desc'				=> __( '*Default is, <code style="color: #0073aa;">Manrope, Arial, -apple-system, BlinkMacSystemFont, "Segoe UI", "Open Sans", "Helvetica Neue", sans-serif</code><br> Click Here To Get Font <a href="https://www.cdnfonts.com/" target="_blank">cdnfonts.com</a>', THEMES_NAMES ), 
			),
			array(
            ...
            'desc'				=> __('Pick Background Color for the theme.', THEMES_NAMES),
            'default'			=> '#EFF7F1',
            'validate'			=> 'color',
			),
			array(
            ...
            'desc'				=> __('Pick Background Header Color for the theme.', THEMES_NAMES),
            'default'			=> '#ffffff',
            'validate'			=> 'color',
			),
			array(
            ...
            'desc'				=> __('Pick Background Header Color for the theme (dark).', THEMES_NAMES),
            'default'			=> '#2A4055',
            'validate'			=> 'color',
			),
			array(
            ...
            'desc'				=> __('Pick Background Footer Color for the theme.', THEMES_NAMES),
            'default'			=> '#142636',
            'validate'			=> 'color',
			),
			array(
			...
			'id'				=> 'color_link_alt',
			'type'     			=> 'link_color',
			'title'    			=> __( 'Color Link', THEMES_NAMES ),  
			'default'  			=> array(
			'regular' 			=> '#999999',
			'hover'   			=> '#438bd3',
			'active'  			=> false,
			...
			*/
            ...
            'desc'				=> __('Pick Color Link Url for the theme.', THEMES_NAMES),
            'default'			=> '#fff',
            'validate'			=> 'color',
			),
			/* 
            ...
            'desc'				=> __('Pick Color Link Menu for the theme.', THEMES_NAMES),
            'default'			=> '#000000',
            'validate'			=> 'color',
			),
			array(
            ...
            'desc'				=> __('Pick Color Heading Text for the theme.', THEMES_NAMES),
            'default'			=> '#172B3D',
            'validate'			=> 'color',
			),
			array(
            ...
            'desc'				=> __('Pick Color Text for the theme.', THEMES_NAMES),
            'default'			=> '#fff',
            'validate'			=> 'color',
			),
			array(
			'id'				=> 'color_button_alt',
			'type'     			=> 'link_color',
			'title'    			=> __( 'Color Download Button ', THEMES_NAMES ),  
            'desc'				=> __('Pick Color Download Button for the theme', THEMES_NAMES),
			'default'  			=> array(
			'regular' 			=> '#008080',
			'hover'   			=> '#008080',
			'active'  			=> false,
            ...
            'desc'				=> __('Pick Color Border Button for the theme', THEMES_NAMES),
            'default'			=> '#008080',
            'validate'			=> 'color',
			),  
			array(
			'id'				=> 'color_svg_alt',
			'type'     			=> 'link_color',
			'title'    			=> __( 'Color SVG ', THEMES_NAMES ),  
            'desc'				=> __('Pick SVG Icon Color for the theme', THEMES_NAMES),
			'default'  			=> array(
			'regular' 			=> '#4ccb70',
			'hover'   			=> '#f9563d',
			'active'  			=> false,
			...
			*/
			...
			'id'				=> 'color_rgba_alt',
			'type'     			=> 'link_color',
			'title'    			=> __( 'Color Rgba ', THEMES_NAMES ),  
			'default'  			=> array(
			'regular' 			=> '#FEDE4A',
			'hover'   			=> '#008080',
			'active'  			=> false,
            ...
            'desc'				=> __('Pick Social Icons Color for the theme.', THEMES_NAMES),
            'default'			=> '#008080',
            'validate'			=> 'color',
			),
			array(
            ...
            'desc'				=> __('Pick Color Yellow for the theme', THEMES_NAMES),
            'default'			=> '#f9bd3b',
            'validate'			=> 'color',
			),
			...
			array(
			'id'       			=> 'color_s_yellow_bg_alt',
			'type'     			=> 'color_gradient',
			'title'    			=> __('Color Background Yellow', TEXT_DOMAIN),
			'validate' 			=> 'color',
			'gradient-type'		=> false,
			...
			*/
			...
			array(
			'id'       			=> 'color_s_green_bg_alt',
			'type'     			=> 'color_gradient',
			'title'    			=> __('Color Background Green', TEXT_DOMAIN),
			'validate' 			=> 'color',
			'gradient-type'		=> false,
			'gradient-reach' 	=> false,
			'gradient-angle' 	=> false,
			...
			*/
			...
			array(
			'id'       			=> 'color_s_purple_bg_alt',
			'type'     			=> 'color_gradient',
			'title'    			=> __('Color Background Purple', TEXT_DOMAIN),
			'validate' 			=> 'color',
			'gradient-type'		=> false,
			'gradient-reach' 	=> false,
			'gradient-angle' 	=> false,
			...
			array(
			'id'       			=> 'color_s_red_bg_alt',
			'type'     			=> 'color_gradient',
			'title'    			=> __('Color Background Red', TEXT_DOMAIN),
			'validate' 			=> 'color',
			'gradient-type'		=> false,
			'gradient-reach' 	=> false,
			'gradient-angle' 	=> false,
			...
			array(
			'id'       			=> 'color_s_blue_bg_alt',
			'type'     			=> 'color_gradient',
			'title'    			=> __('Color Background Blue', TEXT_DOMAIN),
			'validate' 			=> 'color',
			'gradient-type'		=> false,
			'gradient-reach' 	=> false,
			'gradient-angle' 	=> false,
            ...
            'desc'				=> __('Pick Color Nav for the theme', THEMES_NAMES),
            'default'			=> '#f9bd3b',
            'validate'			=> 'color',
			), 
			*/
			...
			'id'				=> 'color_nav_alt',
			'type'     			=> 'link_color',
			'title'    			=> __( 'Color Pagenavy ', THEMES_NAMES ),  
			'default'  			=> array(
			'regular' 			=> '#f9bd3b',
			'hover'   			=> '#f9aa00',
			'active'  			=> false,
			...
			array(
			'id'				=> 'color_nav_link_alt',
			'type'     			=> 'link_color',
			'title'    			=> __( 'Color Link Pagenavy ', THEMES_NAMES ),  
            'desc'				=> __('Pick Color Pagenavy Link for the theme', THEMES_NAMES),
			'default'  			=> array(
			'regular' 			=> '#ffffff',
			'hover'   			=> '#172B3D',
			'active'  			=> false,
			...
			*/
            ...
            'desc'				=> __('Pick Color Like for the theme', THEMES_NAMES),
            'default'			=> '#4ccb70',
            'validate'			=> 'color',
			),
			array(
            ...
            'desc'				=> __('Pick Color Dislike for the theme ', THEMES_NAMES),
            'default'			=> '#f9563d',
            'validate'			=> 'color',
			),
			array(
			'id'				=> 'color_bg_cats',
			'type'     			=> 'color_gradient',
			'title'				=> __('Colors Background Cats', THEMES_NAMES), 
			'validate' 			=> 'color',
			'gradient-type'		=> false,
			'gradient-reach' 	=> false,
			'gradient-angle' 	=> false,
            ...
            'id'				=> 'color_bg_cloud',
            'type'				=> 'color',
            'title'				=> __('Cloud Color', THEMES_NAMES),
            'desc'				=> __('Pick Color Background Cloud for the theme ', THEMES_NAMES),
            'default'			=> '#142636',
            'validate'			=> 'color',
			),
			array(
            'id'				=> 'color_bg_cloud_alt_1',
            'type'				=> 'color',
            'title'				=> __('Cloud Color alt 1', THEMES_NAMES),
            'desc'				=> __('Pick Color Background Cloud for the theme ', THEMES_NAMES),
            'default'			=> '#fbfcf3',
            'validate'			=> 'color',
			),
			array(
            'id'				=> 'color_bg_cloud_alt_2',
            'type'				=> 'color',
            'title'				=> __('Cloud Color alt 2', THEMES_NAMES),
            'desc'				=> __('Pick Color Background Cloud for the theme ', THEMES_NAMES),
            'default'			=> '#8224e3',
            'validate'			=> 'color',
			),
            ...
            'id'				=>  'color_news',
            'type'				=> 'color',
            'title'				=> __('Color News Icon', THEMES_NAMES),
            'desc'				=> __('Pick Color News Icon for the theme.', THEMES_NAMES),
            'default'			=> '#ff0000',
            'validate'			=> 'color',
			),
			array(
            'id'				=>  'color_updates',
            'type'				=> 'color',
            'title'				=> __('Color Updates Icon', THEMES_NAMES),
            'desc'				=> __('Pick Color Updates Icon for the theme.', THEMES_NAMES),
            'default'			=> '#37b6e5',
            'validate'			=> 'color',
			),
			array(
            'id'				=>  'color_mods',
            'type'				=> 'color',
            'title'				=> __('Color Mods Icon', THEMES_NAMES),
            'desc'				=> __('Pick Color Mods Icon for the theme.', THEMES_NAMES),
            'default'			=> '#1e73be',
            'validate'			=> 'color',
			),
