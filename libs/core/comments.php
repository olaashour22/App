...
function better_comments( $comment, $args, $depth ) { ?>
    ...
    switch ( $comment->comment_type ) :
        case 'pingback' :
        case 'trackback' : ?>
	<div class="pingback-entry"><span class="pingback-heading"><?php _e( 'Pingback:', TEXT_DOMAIN ); ?></span> <?php comment_author_link(); ?></div>
	...
	<time class="date c-muted" datetime="<?php printf(  __( '%1$sT%2$s', TEXT_DOMAIN ), get_comment_date(), get_comment_time() ); ?>"><?php printf(  __( '%1$s', TEXT_DOMAIN ), get_comment_date(), get_comment_time() ); ?></time>
	</div> 
	</div> 
