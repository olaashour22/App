...
class intro_widgets extends WP_Widget {
	...
	public function form( $instance ){
		...
		?>
		<p style="text-align: center;font-weight: bold;"><?php _e('Intro Widget', THEMES_NAMES); ?> </p>
		<hr />
		<p>
		...
		<p>
			<label for="<?php echo esc_html( $this->get_field_id( 'image_uri' ) ); ?>"><?php _e( 'BACKGROUND :', THEMES_NAMES ); ?></label>
		</p>		
		<p>
		...
		<?php } if(!$instance['image_uri']){ ?>
		<p><?php _e('Default Background is', THEMES_NAMES); ?> : </p>
		<p>
		...
		<p>
			...
			<?php if(!$instance['image_uri']){ ?>
			<p>
			* <?php _e('Upload your Background. if not upload, Backgrounds using by default,', THEMES_NAMES); ?> <br>
			* <?php _e('Delete Url if you want use by default', THEMES_NAMES); ?>
			</p> 
			<?php } ?>
		<hr />	
		<p>
