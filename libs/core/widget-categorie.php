...
class widget_categorie_homes_ extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
		...
		<a class="btn <?php echo $colors_svg; ?> btn-all" href="<?php echo $link_title; ?>" aria-label="<?php echo $readmores; ?>">
    ...
    public function form( $instance ) {
        ...
        ?>
		<p style="text-align: center;font-weight: bold;"><?php _e('Post by Selected Categorie Widget', THEMES_NAMES); ?> </p>
		<hr />
        <p>
		...
		<hr />
        <p>
            <label for="<?php echo esc_html( $this->get_field_id( 'icon' ) ); ?>"><?php _e( 'Icons :', THEMES_NAMES  ); ?></label>
        </p>
        <p>
			<select class="widefat" id="<?php echo esc_html( $this->get_field_id( 'icon', THEMES_NAMES  ) ); ?>" name="<?php echo esc_html( $this->get_field_name( 'icon' ) ); ?>">
				<option value="gamepad" <?php selected( $instance['icon'], 'gamepad' ); ?>><?php _e( 'Games', THEMES_NAMES  ); ?></option>
				<option value="apps" <?php selected( $instance['icon'], 'apps' ); ?>><?php _e( 'Apps', THEMES_NAMES  ); ?></option>
            </select> 
		 
		 </p>
            <p><small><?php _e('Use', THEMES_NAMES); ?> <b style="color: blue;">Games</b> <?php _e('for Categories Games Icons', THEMES_NAMES); ?> </small></p>
			<p><small><?php _e('Use', THEMES_NAMES); ?> <b style="color: blue;">Apps</b> <?php _e('for Categories Apps Icons', THEMES_NAMES); ?> </small></p>
        </p>
		<hr />
        <p>
