...
class widget_news_homes_ extends WP_Widget { 
    ...
    public function __construct() {
        $widget_ops = array(
            ...
            'description' => __( EX_THEMES_NAMES_.' Display all post News on home pages.', THEMES_NAMES ),
        );
        parent::__construct( 'news-home-widgets', __( '(5Play) News Homes Widget', THEMES_NAMES ), $widget_ops );
    } 
    ...
    public function form( $instance ) {
        $instance = wp_parse_args(
            (array) $instance,
            array(
                'title'             => __( 'Last news', THEMES_NAMES ),
                'readmores'			=> __( 'All news', THEMES_NAMES ),
                'icon'    		    => 'apps',
        ...
        ?>
		<p style="text-align: center;font-weight: bold;"><?php _e('News Homes Widget', THEMES_NAMES); ?> </p>
		<hr />
        <p>
		...
		<hr />
        <p>
            <label for="<?php echo esc_html( $this->get_field_id( 'readmores' ) ); ?>"><?php _e( 'Button Title :', THEMES_NAMES ); ?></label>
        </p>
        <p>
		...
		<hr />
        <p>
            <label for="<?php echo esc_html( $this->get_field_id( 'link_title' ) ); ?>"><?php _e( 'Button Link', THEMES_NAMES ); ?></label>
        </p>
        <p>
        ...
        <p>        
            <small><?php _e('Target url for title, example :', THEMES_NAMES); ?> <?php echo home_url( '/' ); ?>, <?php _e('leave blank if you want using title without link.', THEMES_NAMES); ?> </small>
        </p>
		<hr />
        <p>
		...
		<hr />		
		<p>
			<input class="checkbox" type="checkbox" <?php checked( $show_date ); ?> id="<?php echo esc_html( $this->get_field_id( 'show_date' ) ); ?>" name="<?php echo esc_html( $this->get_field_name( 'show_date' ) ); ?>" /><label for="<?php echo esc_html( $this->get_field_id( 'show_date' ) ); ?>"><?php _e( 'Show Post Dates?', THEMES_NAMES ); ?></label>
		</p>
		<hr />	
		<p>
			<input class="checkbox" type="checkbox" <?php checked( $show_view ); ?> id="<?php echo esc_html( $this->get_field_id( 'show_view' ) ); ?>" name="<?php echo esc_html( $this->get_field_name( 'show_view' ) ); ?>" /><label for="<?php echo esc_html( $this->get_field_id( 'show_view' ) ); ?>"><?php _e( 'Show Post Views?', THEMES_NAMES ); ?></label>
		</p>
		<hr />
        <p>
            <label for="<?php echo esc_html( $this->get_field_id( 'formatdate' ) ); ?>"><?php _e( 'Format Date:', THEMES_NAMES ); ?></label>
        </p>
        <p>
        ...
        <p>
            <small>Default is : <b>F j, Y </b> , <br> <?php _e('to know format dates, check here', THEMES_NAMES); ?> <br> https://wordpress.org/support/article/formatting-date-and-time/ </small>
        </p> 
		<hr />	
		<p>
			...
			<input class="checkbox" type="checkbox" <?php checked( $show_link ); ?> id="<?php echo esc_html( $this->get_field_id( 'show_link' ) ); ?>" name="<?php echo esc_html( $this->get_field_name( 'show_link' ) ); ?>" /><label for="<?php echo esc_html( $this->get_field_id( 'show_link' ) ); ?>"><?php _e( 'Show Read Mores?', THEMES_NAMES ); ?></label>
		</p>
		<hr />
		<p>
			<label for="<?php echo esc_html( $this->get_field_id( 'desc_length' ) ); ?>"><?php _e( 'Maximum length of description', THEMES_NAMES ); ?></label>
