...
global $opt_themes; 
if($opt_themes['ex_themes_adv_single_page_active_']) { ?>
...
global $opt_themes; 
if($opt_themes['ex_themes_adv_single_page_active_2']) { ?>
...
global $opt_themes; 
if($opt_themes['ex_themes_adv_download_page_active_']) { ?>
...
global $opt_themes; 
if($opt_themes['ex_themes_adv_download_page_active_2']) { ?>
...
global $opt_themes; 
if($opt_themes['ex_themes_adv_homes_active_']) { ?>
...
global $opt_themes; 
if($opt_themes['ex_themes_adv_homes_active_2']) { ?>
