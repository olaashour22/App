...
<noscript> 
downloadlink2 : <?php print_r( $gets_data['downloadlink2']); ?>  
<br>
namedownloadlink2 : <?php print_r( $gets_data['namedownloadlink2']); ?>  
<br>
backgrounds_GP : <?php print_r( $gets_data['backgrounds_GP']); ?>  
<br>
downloadlinks_gma : <?php print_r( $gets_data['downloadlinks_gma']); ?>  
<br>
...
<figure class="wp-block-table play_menu">
	<table class="has-fixed-layout app-box-info">
		<tbody>		
			...
			<?php } if ($gets_data['getpricetext']) { ?>
			<tr class="apkextractor" >
				<th class="has-text-align-left has-small-font-size has-cyan-bluish-gray-color">
					Paid 
				</th>
				<td class="has-text-align-left truncate">
					<?php print_r( $gets_data['getpricetext']) ?> (<?php print_r( $gets_data['isfree']) ?>)
				</td>
			</tr>
