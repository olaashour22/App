...
function wp_getmodsapk_errors() {
$sources        = 'getmodsapk.com';
?>
...
function wp_getmodsapk() {
$types			= 'post';
$sources		= 'getmodsapk.com';
$demos			= 'https://getmodsapk.com/grim-soul-dark-fantasy-survival-mod-apk/'; 
?>
    ...
    if(isset($_POST['wp_sb'])) {
        ...
        if(isset($_POST['wp_url'])) {
            ...
            if(stristr($url, $sources)) {
                require_once 'getmodsapk.class.php';
				########## 
				global $opt_themes;
