...
$ukuran_bg						= '=w1475-h720-c';	
$arr['cover']					= $appinfo->getCover()->getUrl().$ukuran_bg;
...
$arr['getpricetext']			= $appinfo->getPriceText();
$arr['isfree']			        = $appinfo->isFree();
...
$arr['genres_GP']               = str_replace('&', '',  $arr['genres_GP']);
} else {
...
if ($arr['youtube_GP'] === FALSE or $arr['youtube_GP'] == '') $arr['youtube_GP'] = $arr['youtube_GP_alt'];	
