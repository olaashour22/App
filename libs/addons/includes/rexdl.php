...
$types			= 'post';
$sources		= 'rexdl.com';
$demos			= 'https://rexdl.com/android/house-flipper-home-design-apk.html/'; 
?>
			...
			<section>
				<div class="row">
                    ...
                    function latest_games() {
						$target1	= 'https://rexdl.com/android/game/'; 
						$target2	= 'https://rexdl.com/android/game/page/2/';
                        ...
                        foreach($html->find("div.hu-pad.group article") as $article) {
						// get title
                        ...
                        foreach($html2->find("div.hu-pad.group article") as $article) {
						// get title
						$item['title']		= trim($article->find('h2', 0)->{'plaintext'});
						$item['url']		= trim($article->find('h2 a', 0)->href) ;
						$item['version']	= trim($article->find('span.text-gray-500', 0)->{'plaintext'});
			...
			<section>
				<div class="row">
                    ...
                    function latest_apps() {
						$target1	= 'https://rexdl.com/android/app/'; 
						$target2	= 'https://rexdl.com/android/app/page/2/';
                        $html		= file_get_html($target1, LIBXML_NOERROR);
                        $html2		= file_get_html($target2, LIBXML_NOERROR);
                        // get article block //a/dl/dd[@class='new-games']/text() dd class="d1"
                        foreach($html->find("div.hu-pad.group article") as $article) {
